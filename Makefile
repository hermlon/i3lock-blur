...
pkgdatadir = $(datadir)/i3lock
pkgincludedir = $(includedir)/i3lock
pkglibdir = $(libdir)/i3lock
pkglibexecdir = $(libexecdir)/i3lock
...
am_i3lock_OBJECTS = i3lock-blur.$(OBJEXT) i3lock-i3lock.$(OBJEXT) \
 i3lock-randr.$(OBJEXT) i3lock-unlock_indicator.$(OBJEXT) \
 i3lock-xcb.$(OBJEXT) i3lock-point_list.$(OBJEXT)
...
ACLOCAL = ${SHELL} /home/hermlon/code/i3lock-blur/missing aclocal-1.15
AMTAR = $${TAR-tar}
AM_CFLAGS = -Wunused-value
AM_DEFAULT_VERBOSITY = 0
AR = ar
AUTOCONF = ${SHELL} /home/hermlon/code/i3lock-blur/missing autoconf
AUTOHEADER = ${SHELL} /home/hermlon/code/i3lock-blur/missing autoheader
AUTOMAKE = ${SHELL} /home/hermlon/code/i3lock-blur/missing automake-1.15
AWK = gawk
AX_EXTEND_SRCDIR_CPPFLAGS = -DSTRIPPED__FILE__=\"$$(basename $<)\"
CAIRO_CFLAGS = -I/usr/include/cairo -I/usr/include/glib-2.0 -I/usr/lib/glib-2.0/include -I/usr/include/pixman-1 -I/usr/include/freetype2 -I/usr/include/libpng16 -I/usr/include/harfbuzz -I/usr/include/uuid 
CAIRO_LIBS = -lcairo 
CC = gcc
...
GL_LIBS = -lGL 
GREP = /usr/bin/grep
I3LOCK_VERSION = 2.10 (2018-03-06, branch \"tags/2.10\")
...
LDFLAGS = 
LIBOBJS = 
LIBS = -lpam -lrt -lev -lm 
LN_S = ln -s
LTLIBOBJS = 
MAINT = 
MAKEINFO = ${SHELL} /home/hermlon/code/i3lock-blur/missing makeinfo
...
VERSION = 2.10
X11_CFLAGS = 
X11_LIBS = -lX11-xcb -lX11 -lxcb 
XCB_CFLAGS = 
XCB_IMAGE_CFLAGS = 
XCB_IMAGE_LIBS = -lxcb-image -lxcb -lxcb-shm 
XCB_LIBS = -lxcb -lxcb-xkb -lxcb-xinerama -lxcb-randr -lxcb-damage -lxcb-dpms -lxcb-composite 
XCB_UTIL_CFLAGS = 
XCB_UTIL_LIBS = -lxcb-util -lxcb 
XKBCOMMON_CFLAGS = 
XKBCOMMON_LIBS = -lxkbcommon-x11 -lxkbcommon 
abs_builddir = /home/hermlon/code/i3lock-blur/x86_64-pc-linux-gnu
abs_srcdir = /home/hermlon/code/i3lock-blur/x86_64-pc-linux-gnu/../../i3lock-blur
abs_top_builddir = /home/hermlon/code/i3lock-blur/x86_64-pc-linux-gnu
abs_top_srcdir = /home/hermlon/code/i3lock-blur/x86_64-pc-linux-gnu/../../i3lock-blur
ac_ct_AR = ar
ac_ct_CC = gcc
am__include = include
am__leading_dot = .
...
install_sh = ${SHELL} /home/hermlon/code/i3lock-blur/install-sh
...
all all-all:
	@ HOST="$(HOST)" \
	; test ".$$HOST" = "." && HOST=` sh /home/hermlon/code/i3lock-blur/config.guess ` \
